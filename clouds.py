...
def main():
    ...
    parser.add_argument('--width', type=int, default=900, help='Width of the word cloud image')
    parser.add_argument('--height', type=int, default=1024, help='Height of the word cloud image')
    parser.add_argument('--font', default='DejaVu Sans', help='Font to use (must support Cyrillic)')
    parser.add_argument('--max-font-size', type=int, default=120, help='Maximum font size')
